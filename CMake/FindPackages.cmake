...
if(BISON_name)
  list(APPEND FIND_PACKAGES_DEFINES MOD2C_USE_BISON)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND MOD2C_DEPENDENT_LIBRARIES BISON)
  endif()
...
if(FLEX_name)
  list(APPEND FIND_PACKAGES_DEFINES MOD2C_USE_FLEX)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND MOD2C_DEPENDENT_LIBRARIES FLEX)
  endif()
...
set(MOD2C_BUILD_DEBS autoconf;automake;cmake;doxygen;git;git-review;pkg-config;subversion)

set(MOD2C_DEPENDS BISON;FLEX)
