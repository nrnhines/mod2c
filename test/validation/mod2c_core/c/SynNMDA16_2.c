...
static void _acc_globals_update() {
 #pragma acc update device (Kcs0)
 #pragma acc update device (Kna)
 #pragma acc update device (Kcs)
 #pragma acc update device (Mg)
 #pragma acc update device (V0)
 #pragma acc update device (Vdep)
 #pragma acc update device (a)
 #pragma acc update device (b)
 #pragma acc update device (c)
 #pragma acc update device (d)
 #pragma acc update device (gmax)
 #pragma acc update device (kNi0)
 #pragma acc update device (kNo0)
 #pragma acc update device (kP0)
 #pragma acc update device (kfB0)
 #pragma acc update device (kfF0)
 #pragma acc update device (ksB0)
 #pragma acc update device (ksF0)
 #pragma acc update device (koff)
 #pragma acc update device (kon)
 #pragma acc update device (kNi)
 #pragma acc update device (kNo)
 #pragma acc update device (kP)
 }
...
static void initmodel(_threadargsproto_) {
  int _i; double _save;{
  #pragma acc update device (_mechtype)
  _Memb_list* _ml = _nt->_ml_list[_mechtype];
  OMg = OMg0;
  O = O0;
  RA2sMg = RA2sMg0;
...
{
  nao = _ion_nao;
 {  sparse_thread(&_thread[_spth1]._pvoid, 16, _slist1, _dlist1, &t, dt, kstates, _linmat1, _threadargs_);
  }}}
