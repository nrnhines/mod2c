...
#define mggate _p[32*_STRIDE]
#define DA_AMPA _p[33*_STRIDE]
#define DB_AMPA _p[34*_STRIDE]
#define DA_NMDA _p[35*_STRIDE]
#define DB_NMDA _p[36*_STRIDE]
#define v _p[37*_STRIDE]
